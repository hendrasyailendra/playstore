...
The App does not replace learning from a qualified teacher (ustaz/ustazah)

Users are encouraged to verify recitation, tajwid, and memorization with trusted scholars
...
Depending on features used, the App may store:

Hafazan progress and notes
...
That all features will always function without errors
...
Our Deen and its developers are not liable for:

Any inaccuracies in memorization progress or recitation
