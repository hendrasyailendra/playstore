...
Hafazan progress (surahs, ayahs, completion status)

Notes or memorization markers

App preferences and settings

Optional account-related information (if login is enabled)
...
Audio files are played or streamed, not recorded

The App does not record, store, or monitor your voice
...
Store and sync hafazan progress

Provide audio recitation features
...
The App does not include targeted advertising

Content is designed to be respectful, educational, and appropriate for all ages
...
Trusted service providers required to operate the App (e.g. hosting, database services)
